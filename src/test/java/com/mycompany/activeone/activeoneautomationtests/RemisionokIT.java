...
public class RemisionokIT {
    ...
    @Test
    public void remisionflujoexitoso() throws InterruptedException {
        ...
        productoElem.sendKeys("REF-0001 - CAMA");
        WebElement selprodElem = driver.findElement(By.id("list-item-887-0"));
        selprodElem.click();
